...
class Veiculo(ModelView, ModelSQL):
    'Veiculo'
    __name__ = 'oci.veiculo'
    _order = 'name'
    ...
    bonos = fields.One2Many('oci.bono', 'name', 'Bonos')
...
class Bono(Workflow, ModelView, ModelSQL):
    ...
    name = fields.Many2One('oci.veiculo', 'veiculo', required=True,
    ...
    km2 = fields.Numeric('Km actualizados', help='Actualiza el kilometraje del veiculo',
            states={'readonly': Eval('state').in_(['rendido', 'borrador'])})
